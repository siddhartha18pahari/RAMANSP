...
the noise floor, discarding noise rather than encoding it. We also benchmark against Savitzky-Golay and PCA
denoisers and across \MLNmodels{} classifiers on map-level splits, reporting
where the representation loses as well as where it wins. We report the failure modes we hit, including
...
it as measured. The best filter, \MLRefFilter{}, improves mean squared error
over the untouched input by \MLDenoiseGain$	imes$; the Gaussian field does not
