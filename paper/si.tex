...
\url{https://ramanspjs.vercel.app} carries the same material in browsable form,
...
\label{tab:si-corpus}
\IfFileExists{tables/corpus.tex}{\input{tables/corpus.tex}}{(table not built)}
\end{table}
...
\label{tab:si-kg}
\IfFileExists{tables/kg.tex}{\input{tables/kg.tex}}{(table not built)}
\end{table}
...
itself.}
\label{tab:si-splat}
\IfFileExists{tables/splat.tex}{\input{tables/splat.tex}}{(table not built)}
\end{table}
...
\IfFileExists{tables/ml_denoise_tex.tex}
  {\input{tables/ml_denoise_tex.tex}}{(table not built)}
\end{table}
